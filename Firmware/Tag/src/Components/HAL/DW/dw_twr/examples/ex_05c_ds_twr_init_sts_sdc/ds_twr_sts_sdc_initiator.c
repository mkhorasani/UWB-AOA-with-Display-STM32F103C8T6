...
#define APP_NAME "Makerfbs AOA tag v1.0\r\n"
...
void discovery_process()
{
	...
	{
		_dbg_printf("Join network failed, receive timeout or receive error!\n");
...
int ds_twr_sts_sdc_initiator(void)
{
	...
	_dbg_printf("Tag configuration successful %08x%08X\n", (uint32_t)(tagMac >> 32), (uint32_t)(tagMac));
