...
#define APP_NAME "Makerfabs AOA Anchor v1.0\r\n"
...
static tag_reports_t rp[MAX_KNOWN_TAG_LIST_SIZE + 1];
...
int ds_twr_sts_sdc_responder(void)
{
	...
	* Note, in real low power applications the LEDs should not be used. */
	...
	_dbg_printf("Anchor configuration successful\n");
